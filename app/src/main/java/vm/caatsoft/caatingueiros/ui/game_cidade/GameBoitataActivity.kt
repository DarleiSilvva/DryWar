...
class GameBoitataActivity : AppCompatActivity(), GestureDetector.OnGestureListener {
    // Frame
    ...
    private var x2 = 0f
    private var y2 = 0f
    private lateinit var binding: ActivityGameBoitataBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGameBoitataBinding.inflate(layoutInflater)
        ...
        dialog = Dialog(this)
        gestureDetector = GestureDetector(this@GameBoitataActivity, this)
