...
class GameSaciActivity : AppCompatActivity(), GestureDetector.OnGestureListener {
    // Frame
    ...
    private var x2 = 0f
    private var y2 = 0f
    private lateinit var binding: ActivityGameSaciBinding

    @SuppressLint("ClickableViewAccessibility")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGameSaciBinding.inflate(layoutInflater)
        ...
        dialog = Dialog(this)
        gestureDetector = GestureDetector(this@GameSaciActivity, this)
