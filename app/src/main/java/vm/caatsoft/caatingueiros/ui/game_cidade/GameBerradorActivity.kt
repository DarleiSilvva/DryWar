...
class GameBerradorActivity : AppCompatActivity(), GestureDetector.OnGestureListener {
    // Frame
    ...
    private var x2 = 0f
    private var y2 = 0f
    private lateinit var binding: ActivityGameBerradorBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGameBerradorBinding.inflate(layoutInflater)
        ...
        dialog = Dialog(this)
        gestureDetector = GestureDetector(this@GameBerradorActivity, this)
...
/////////////////////////////////////
    ...
    fun mosquito1(){
        ...
        if (colisorJogadorParar(tiroInimigoX, tiroInimigoY, binding.tiroInimigo) ) {
            binding.imageViewArpg.setImageResource(R.drawable.poder_som)
            pontos += 15 * perdaVida
            vidasJogador(pontos)
        }

        if (colisorJogadorParar(mosquitoX, mosquitoY, binding.mosquito) ) {
            binding.imageViewArpg.setImageResource(R.drawable.ic_berrador)
            pontos += 10 * perdaVida
            vidasJogador(pontos)
        }
    }
