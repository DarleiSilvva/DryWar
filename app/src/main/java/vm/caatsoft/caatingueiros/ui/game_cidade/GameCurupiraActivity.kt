...
class GameCurupiraActivity : AppCompatActivity(), GestureDetector.OnGestureListener {
    // Frame
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dialog = Dialog(this)
        gestureDetector = GestureDetector(this@GameCurupiraActivity, this)
...
/////////////////////////////////////
    ...
    fun mosquito1(){
        ...
        if (colisorJogadorParar(tiroInimigoX, tiroInimigoY, binding.tiroInimigo) ) {
            binding.imageViewArpg.setImageResource(R.drawable.poder_lanca)
            pontos += 15 * perdaVida
            vidasJogador(pontos)
        }
