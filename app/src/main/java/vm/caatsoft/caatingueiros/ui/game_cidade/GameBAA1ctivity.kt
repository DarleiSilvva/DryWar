...
class GameBAA1ctivity : AppCompatActivity(), GestureDetector.OnGestureListener {
    // Frame
    ...
    private var x2 = 0f
    private var y2 = 0f
    private lateinit var binding: ActivityGameCurupira2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGameCurupira2Binding.inflate(layoutInflater)
        ...
        dialog = Dialog(this)
        gestureDetector = GestureDetector(this@GameBAA1ctivity, this)
    ...
    fun colisorJogadorY(
        ...
        if (jogadorY + binding.jogador.height >= y && jogadorY <= y + z.height
        ) {
            return true
        }
        return false
    ...
    fun iniciarJogo(view: View?) {
        ...
        when (list.random()){
            1 -> { //DA PARA FAZER O PODER DO SACI AQUI
                posicaoJogadorY = 0f
                posicaoJogadorX = 0f
            }
            2 -> {
...
/////////////////////////////////////
    ...
    fun mosquito1(){
        ...
        if (tiroInimigo == 1 || tiroInimigo == 12 || tiroInimigo == 13 || tiroInimigo == 14) {
        ...
        if (tiroInimigo == 2 || tiroInimigo == 22 || tiroInimigo == 23 || tiroInimigo == 24) {
            tiroInimigoyY += velocidadeMonstroMosquito*2
            tiroInimigoxX -= 0
        ...
        /**E**/
        if (tiroInimigo == 3 || tiroInimigo == 32 || tiroInimigo == 33 || tiroInimigo == 34) {
            tiroInimigoyY += 0
        ...
        /**D**/
        if (tiroInimigo == 4 || tiroInimigo == 42 || tiroInimigo == 43 || tiroInimigo == 44) {
            tiroInimigoyY += 0
            tiroInimigoxX += velocidadeMonstroMosquito*2
